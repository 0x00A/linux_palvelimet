...
1.111B luokan domainit koostuvat 6-9 merkistä, mutta vain numerot ovat sallittuja, joten tälläinen domaini ei ole kovin hyvä jos kyseessä on oikea yritys. Lisää 1.111B luokasta voi lukea [täältä.](https://aydacfu.xyz/)⁰
...
Näitä ohjelmia ei ole selvästi asennettu, ioflood¹ sivuston mukaan host löytyy dnsutils paketista
```bash
...
Tiesin entuudestaan jo, että SPF tiedot löytyvät domainin TXT recordeista mutta uutena opin sen, että DMARC sen sijaan löytyy _dmarc alidomainista⁵.
...
Mahdollisia arvoja lopussa ovat⁴:
